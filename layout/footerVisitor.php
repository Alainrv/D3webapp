...
<nav id="c-menu--slide-left" class="c-menu c-menu--slide-left visitor">
	...
	<ul class="c-menu__items">
		<div class="menu_nav">
		    <li class="c-menu__item login"><a href="#" class="c-menu__link">
		    ...
		    <li class="c-menu__item home"><a href="#" class="c-menu__link">
		    ...
		    <li class="c-menu__item createAccount"><a href="#" class="c-menu__link">
		    	<svg width="15" height="14" viewBox="0 0 15 14" xmlns="http://www.w3.org/2000/svg">
				    <title>
				        Create Account
				    </title>
